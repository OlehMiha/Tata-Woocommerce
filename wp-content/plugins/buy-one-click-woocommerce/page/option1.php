...
<h2 class="nav-tab-wrapper woo-nav-tab-wrapper">
    ...
    <a class="nav-tab <?php BuyCore::adminActiveTab('help'); ?>" href="<?php echo add_query_arg(array('page' => BuyCore::URL_SUB_MENU, 'tab' => 'help'), 'admin.php'); ?>"><span class="glyphicon glyphicon-thumbs-up"></span> Автор</a>
</h2>
