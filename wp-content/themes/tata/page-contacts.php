            ...
            <div class="container">
                ...
                <div class="wrap_contacts">
                    ...
                    <ul class="list_contacts">
                        <li class="contacts">
                            <h5>Адрес</h5>
                            <p>г. Минск, пр-т Победителей, 103, офис 401, 220020</p>
                        </li>
                        <li class="contacts">
                            <h5>Режим работы</h5>
                            <p>Еженевно <br/>9:00 – 21:00</p>
                        </li>
                        <li class="contacts">
                            <h5>Контакт-центр</h5>
                            <p>+375 29 321-33-33</p>
                            <p>+375 25 321-33-35</p>
                            <a href="mailto:info@tata.by">info@tata.by</a>
                        </li>
                    </ul>
                </div>
            </div>
