...
var $default_settings = array(
 ...
 <p><input placeholder="Режим работы" style="width:300px;" name="cp_regim" id="cp_regim" value="'.$this->options["regim"].'"><label> - режим работы</label></p>
 <p><input placeholder="Копирайт" style="width:300px;" name="cp_copy" id="cp_copy" value="'.$this->options["copy"].'"><label> - копирайт</label></p>
