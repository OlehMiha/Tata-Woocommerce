...
<form action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
			...
			if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
				...
				?>				
                    <div class="product_mod_bask">
                        <div class="product_mod_bask_first">
						<?php
		...
		<div class="wrap_checkout_total">
                    <div class="left_checkout_total">
                        <div class="increase_benefits">
                            <h5>Увеличьте свою выгоду!</h5>
                            <p>Добавьте к заказу <a href="#">матрас,</a> чотбы получить дополнительную скудку 10 руб. Соберите комлект: кроватка + матрас + постельное белье и получите скидку 25 руб.</p>
                        </div>
                    </div>
                    <div class="checkout_total">
                        ...
                        <a href="/checkout/" class="orng_btn">Оформить заказ</a>
                    </div>
                </div>
...
<div class="cart-collaterals">
					...
					<input type="submit" class="button hidden" name="update_cart" value="<?php esc_attr_e( '&nbsp;', 'woocommerce' ); ?>" />
